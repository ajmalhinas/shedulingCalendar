...
SchedulerService.getAllFacilitators = function(p0, p1, p2, callback) {
  dwr.engine._execute(SchedulerService._path, 'SchedulerService', 'getAllFacilitators',p0, p1, p2, callback);
}
