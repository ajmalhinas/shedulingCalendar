...
//                    console.log("drow cells " + j);
        ...
        //here drawing a row between column header and other rows (dont know the purpose it)
    ...
    DayPilotCalendar.Cell = function (start, end, column) {
        ...
        alert("Seems this function is not used");
        this.start = start;
        this.end = end;
